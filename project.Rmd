...
Det färdiga projektet skall publiceras som filen `README.md` i ert projektbibliotek (`https://github.com/MT3003-ST21/pr_XXX`) med tillhörande datafiler och eventuella skript-filer. Om ni känner er begränsade av `.md`-formatet och föredrar `.html`, kontakta kursansvarig.
