...
Starta en webbläsare, gå till [https://github.com/MT3003-ST21](https://github.com/MT3003-ST21) och logga in. Kontrollera att det finns en länk lab1-xxx, där xxx är ditt användarnamn. Saknas denna länk kan det bero på att
...
Finns länken där loggar du in på [RStudio Cloud](https://rstudio.cloud/). I vänstermarginalen under Spaces hittar du kursens arbetsyta MT3003-ST21, klicka på den. Två saker att tänka på
...
I dialogrutan som dyker upp fyller du i `https://github.com/MT3003-ST21/lab1_xxx.git` där du ersatt `xxx` med ditt användarnamn. Laborationsunderlaget hämtas nu och RStudio startas upp. 
...
### Först bekräftar du förändringarna. 
...
Om allt gått vägen har du nu skapat en ny version av projektet, för att synkronisera med GitHub klickar du på Push.
...
Kontrollera nu att det ser bra ut även på GitHub (`https://github.com/MT3003-ST21/lab1_xxx`). När du är nöjd meddelar du detta genom att posta en *Issue*. Gå till `https://github.com/MT3003-ST21/lab1_xxx/issues` (eller klicka på fliken ![](img/issues.png)) och välj ![](img/newissue.png). Fyll i "Laboration 1 redo för rättning!" i ämnesraden och klicka Submit new issue. Din laboration är nu inlämnad!

# Kamratgranskning

Dagen efter deadline kommer du få tillgång till en kursares laboration, den kommer dyka upp under `https://github.com/MT3003-ST21/`. Du skall granska två saker
