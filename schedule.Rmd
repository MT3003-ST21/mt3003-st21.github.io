...
knitr::include_graphics("img/lan.png")
```
...
Ett alternativ till `ggplot` för just kartframställning är paketet [`tmap`](https://cran.r-project.org/web/packages/tmap/vignettes/tmap-getstarted.html), som kan vara enklare att använda men mindre felxibelt.
